...
Parser.Parsers['1.7.1.0'] = new Parser(
	// additional data
	{
	...
	[
		...
		{name:"spawnHero", re:/NetworkGame: \w+ \[Process\] \w+#Sync#\d+ SetupPlayerHero \(Player(\d), (\d+), (\w+)\)/i, map:["player", "entity", "corner"]},
		...
		{name:"nextRound", re:/Game: TurnManager\+Message\+PhaseStart: Dispatch\((\w+)\)/i, map:["type"]},
